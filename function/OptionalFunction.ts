...
function fun_one(arg1:string,arg2?:string,arg3:string="hello",...arg4:any):void{        //regular and optional should be last 
console.log(arg1,arg2,arg3,arg4);
};//rest with anyone rest should be last

//fun_one();// Expected at least 1 arguments, but got 0.
fun_one("Angular");//Angular undefined hello []
fun_one("angular","angular",undefined,"angular");//angular angular hello [ 'angular' ]
fun_one(null,null,null,null);//null null null [ null ]



//conclusion:default value of regular =>error
                        //of optional=>undefined
                        //of rest=>[]
                        //default value keep as it is in default function=>undefined
                        //erase default value in default function=>null