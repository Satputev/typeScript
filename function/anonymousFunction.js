...
/*
let fun=():void=>{
    console.log("helloNamedFunction");;
}
fun();*/
function f(namedArg, defaultarg) {
    if (defaultarg === void 0) { defaultarg = "hello2"; }
    var restarg = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        restarg[_i - 2] = arguments[_i];
    }
    console.log(namedArg, defaultarg, restarg);
}
;
f("hello", undefined);
